        ...
        <section className="py-16 px-4 bg-gradient-hero">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Garage Door Repair in Philadelphia, PA
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Professional garage door repair services in Philadelphia, PA. Fast emergency service available.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  We provide garage door repair services throughout the Philadelphia metropolitan area.
                </p>
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                ...
                <p className="text-muted-foreground mb-4">
                  Call now for fast, reliable service in Philadelphia. Our local technicians know the area well.
                </p>
                <Button 
                ...
                >
                  ...
                  <span className="hidden sm:inline">Call Now for Service in PA: (951) 379-4799</span>
        ...
        <section className="py-16 px-4 bg-muted/20">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl font-bold text-foreground text-center mb-12">
              Common Garage Door Issues in Philadelphia
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start p-4 bg-background rounded-lg border border-border">
                <Wrench className="h-6 w-6 text-primary mt-1 mr-4 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">Urban Environment</h3>
                  <p className="text-muted-foreground">
                    City conditions can cause faster wear on garage doors
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-4 bg-background rounded-lg border border-border">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Historic Philadelphia homes may have older garage systems
                  </p>
                </div>
              </div>
            </div>
