        ...
        <section className="py-16 px-4 bg-gradient-hero">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Professional garage door repair services in Miami. Fast emergency service available.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  We provide garage door repair services throughout the Miami metropolitan area.
                </p>
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                ...
                <p className="text-muted-foreground mb-4">
                  Call now for fast, reliable service in Miami. Our local technicians know the area well.
                </p>
                <Button 
                ...
                >
                  ...
                  <span className="hidden sm:inline">Call Now for Service in Miami: (951) 379-4799</span>
        ...
        <section className="py-16 px-4 bg-muted/20">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl font-bold text-foreground text-center mb-12">
              Common Garage Door Issues in Miami
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start p-4 bg-background rounded-lg border border-border">
                <Wrench className="h-6 w-6 text-primary mt-1 mr-4 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">Salt Air Corrosion</h3>
                  <p className="text-muted-foreground">
                    Ocean air can corrode metal parts faster
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-4 bg-background rounded-lg border border-border">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Hurricanes and storms can damage doors and tracks
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-4 bg-background rounded-lg border border-border">
                <Wrench className="h-6 w-6 text-primary mt-1 mr-4 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">Heat Expansion</h3>
                  <p className="text-muted-foreground">
                    High temperatures can cause parts to expand and bind
                  </p>
                </div>
              </div>
            </div>
