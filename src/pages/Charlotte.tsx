        ...
        <section className="py-16 px-4 bg-gradient-hero">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Professional garage door repair services in Charlotte, NC. Fast emergency service available.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  We provide garage door repair services throughout the Charlotte metropolitan area.
                </p>
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                ...
                <p className="text-muted-foreground mb-4">
                  Call now for fast, reliable service in Charlotte. Our local technicians know the area well.
                </p>
                <Button 
                ...
                >
                  ...
                  <span className="hidden sm:inline">Call Now for Service in NC: (951) 379-4799</span>
        ...
        <section className="py-16 px-4 bg-muted/20">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl font-bold text-foreground text-center mb-12">
              Common Garage Door Issues in Charlotte
            </h2>
